...
public class JenkinsIntegrationTest {
    ...
    public void testArtifactScanStepIsRegistered() {
        ...
        ArtifactScanStep.DescriptorImpl desc = jenkins.jenkins
                .getDescriptorByType(ArtifactScanStep.DescriptorImpl.class);
        assertNotNull(desc);
    }

    @Test
    public void testSourceCodeScanStepIsRegistered() {
        // Verifies that SourceCodeScanStep is properly registered as a Jenkins build
        // step
        SourceCodeScanStep.DescriptorImpl desc = jenkins.jenkins
                .getDescriptorByType(SourceCodeScanStep.DescriptorImpl.class);
        assertNotNull(desc);
    }
